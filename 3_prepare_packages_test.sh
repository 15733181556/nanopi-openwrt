...
rm -rf luci-lib-docker/ && svn co https://github.com/lisaac/luci-lib-docker/trunk/collections/luci-lib-docker
rm -rf luci-app-dockerman/ && svn co https://github.com/lisaac/luci-app-dockerman/trunk/applications/luci-app-dockerman
cd ../../
