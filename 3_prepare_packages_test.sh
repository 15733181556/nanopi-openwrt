...
rm -rf luci-lib-docker/ svn co clone https://github.com/lisaac/luci-lib-docker/tree/master/collections/luci-lib-docker
rm -rf luci-app-dockerman/ svn co clone https://github.com/lisaac/luci-app-dockerman/tree/master/applications/luci-app-dockerman
cd ../../
